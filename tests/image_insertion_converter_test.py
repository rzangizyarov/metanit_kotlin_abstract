...
class ImageInsertionConverterTest(unittest.TestCase):
    ...
    def test_find_md_files(self):
        ...
        self.assertEqual(
            ...
            second=['./markdown_with_refs.md',
                    './markdown_with_refs_result.md',
                    './markdown_with_tags.md',
                    './markdown_with_tags_result.md',
    ...
    def test_ref_to_tag(self):
        self.image_insertion_converter.ref_to_tag(['./markdown_with_refs.md'], False)

        with open('./markdown_with_refs_result.md', 'r', encoding='utf-8') as f:
            result_markdown = f.read()

        with open('./markdown_with_tags.md', 'r', encoding='utf-8') as f:
            expected_markdown = f.read()
